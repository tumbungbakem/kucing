...
commonname=tumbungbakem
email=effataidstore@gmail.com

# simple password minimal
wget -q -O /etc/pam.d/common-password "https://raw.githubusercontent.com/tumbungbakem/kucing/main/tools/password"
...
wget -q -O /usr/local/bin/ws-dropbear "https://raw.githubusercontent.com/tumbungbakem/kucing/main/tools/ws-dropbear"
chmod +x /usr/local/bin/ws-dropbear

# Installing Service
cat > /etc/systemd/system/ws-dropbear.service << END
[Unit]
Description=Ssh Websocket By tumbungbakem
...
wget -q -O /usr/local/bin/ws-stunnel "https://raw.githubusercontent.com/tumbungbakem/kucing/main/tools/ws-stunnel"
chmod +x /usr/local/bin/ws-stunnel

# Installing Service Ovpn Websocket
cat > /etc/systemd/system/ws-stunnel.service << END
[Unit]
Description=Ovpn Websocket By tumbungbakem
Documentation=https://web.cobeksawit.xyz:5255
After=network.target nss-lookup.target
[Service]
Type=simple
...
wget -q -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/tumbungbakem/kucing/main/tools/newudpgw"
...
# Install Stunnel5
cd /root/
wget -q "https://raw.githubusercontent.com/tumbungbakem/kucing/main/tools/stunnel5.zip"
unzip stunnel5.zip
cd /root/stunnel
chmod +x configure
./configure
...
wget -q -O /etc/init.d/stunnel5 "https://raw.githubusercontent.com/tumbungbakem/kucing/main/tools/stunnel5.init"
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/tumbungbakem/kucing/main/issue.net"
