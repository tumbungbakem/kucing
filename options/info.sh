...
Isadmin=$(curl -sS https://raw.githubusercontent.com/tumbungbakem/taikucing/main/mek | grep $MYIP | awk '{print $5}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/tumbungbakem/taikucing/main/mek | grep $MYIP | awk '{print $3}')
fi
